async function broadcastProduction() {
  const backendUrl = "https://backend-production-427f.up.railway.app";
  ...
  console.log(`Triggering production broadcast on ${backendUrl}/api/broadcast...`);
  ...
  try {
    ...
    console.log('Production Broadcast Response:', data);
  } catch (err) {
